...
Usage:
    python generate_drug_summaries.py --input drugsComTrain_final.csv --outdir ./drug_summaries --outdir ./drug_summaries --batch-size 20
...
# Main driver
def generate_summaries(input_csv, outdir="./drug_summaries", batch_size=50, sleep_between=0.2, max_drugs=None):
...
if __name__ == '__main__':
    ...
    generate_summaries(args.input, args.outdir, batch_size=args.batch_size, sleep_between=args.sleep, max_drugs=args.max_drugs)
